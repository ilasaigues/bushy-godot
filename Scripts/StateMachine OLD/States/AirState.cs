...
{
    [Scene]
    public partial class AirStateOld : BaseStateOLD
    {/*
        ...
        public override void InitState(MovementComponent mc, CharacterVariables cv, PlayerInfo ac, AnimationComponent anim,
            CharacterCollisionComponent col, PlayerStateController sm)
        {
        ...
        protected override void AnimationUpdate()
        {
            ...
            if (animationLevel == StateExecutionState.AnimationLevel.UNINTERRUPTIBLE) return;
        ...
        void CheckTransitions()
        {
            ...
            if (verticalVelocity > 0)
            {
                ...
                var animationLevel = this.stateMachine.MachineState.CurrentAnimationLevel;
                if (animationLevel != StateExecutionState.AnimationLevel.UNINTERRUPTIBLE) animationComponent.Play("land");
